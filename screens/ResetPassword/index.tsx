...
const ResetPasswordScreen = () => {
    ...
    const handleResetPassword = async () => {
        ...
        try {
            setIsLoading(true);
            await sendResetPasswordRequest({token, newPassword} as ResetPasswordRequest);
            toast.success({
            ...
            toast.error({
                title: formatMessage(messages.error),
                // @ts-ignore
                description: error.response?.data?.message ?? formatMessage(messages.errorDefault),
            });
        } finally {
            setIsLoading(false);
            ...
            <Container>
                ...
                <InputWrapper>
                    {token ? (
                        ...
                        <BaseText size="s">
                            {formatMessage(messages.checkEmail, {email: email || 'your inbox'})}
                        </BaseText>
                    )}
                </InputWrapper>
            </Container>
