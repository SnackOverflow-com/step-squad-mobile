...
const ProfileScreen = () => {
    ...
    const updateUserMutation = useMutation({
        mutationFn: (userUpdateRequest: UserUpdateRequest) => updateUser(userUpdateRequest),
        ...
        <SafeAreaWrapper>
            <Container>
                ...
                <InputWrapper>
                    ...
                    <Controller
                        ...
                        render={({field: {onChange, value}}) => (
                            <Dropdown
                                ...
                                error={errors.gender ? String(errors.gender.message) : undefined}
                            />
                        )}
                    />
                    ...
                    {errors.root && <ErrorText size="xs">{errors.root.message}</ErrorText>}
                </InputWrapper>
